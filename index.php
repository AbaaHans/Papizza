...
<div id="carouselExampleCaptions " class="carousel  slide" data-bs-ride="carousel">
  ...
  <div class="carousel-inner  ">
    ...
    <img src="assets/images/papizza/slider-papizza/slider1.jpg" class="d-block w-100 vh-100" alt="...">
    ...
    <div class="carousel-item  " data-bs-interval="5000">
     <img src="assets/images/papizza/slider-papizza/slider2.jpg" class="d-block w-100 vh-100" alt="...">
      <!-- <div class="carousel-caption d-none d-md-block">
    ...
    <div class="carousel-item  " data-bs-interval="5000">
     <img src="assets/images/papizza/slider-papizza/slider3.jpg" class="d-block w-100 vh-100"  alt="...">
      <!-- <div class="carousel-caption d-none d-md-block">
        <h5>Second slide label</h5>
        <p>Some representative placeholder content for the second slide.</p>
      </div> -->
    ...
    <div class="carousel-item  " data-bs-interval="5000">
     <img src="assets/images/papizza/slider-papizza/slider4.jpg" class="d-block w-100 vh-100" alt="...">
      <!-- <div class="carousel-caption d-none d-md-block">
        <h5>Second slide label</h5>
        <p>Some representative placeholder content for the second slide.</p>
      </div> -->
    ...
    <div class="carousel-item  " data-bs-interval="5000">
     <img src="assets/images/papizza/slider-papizza/slider5.jpg" class="d-block w-100 vh-100" alt="...">
      <!-- <div class="carousel-caption d-none d-md-block">
        <h5>Second slide label</h5>
        <p>Some representative placeholder content for the second slide.</p>
      </div> -->
    ...
    <div class="carousel-item  " data-bs-interval="5000">
     <img src="assets/images/papizza/slider-papizza/slider6.jpg" class="d-block w-100 vh-100" alt="...">
      <!-- <div class="carousel-caption d-none d-md-block">
        <h5>Second slide label</h5>
        <p>Some representative placeholder content for the second slide.</p>
      </div> -->
    ...
    <div class="carousel-item  " data-bs-interval="5000">
     <img src="assets/images/papizza/slider-papizza/slider7.jpg" class="d-block w-100 vh-100" alt="...">
      <!-- <div class="carousel-caption d-none d-md-block">
        <h5>Second slide label</h5>
        <p>Some representative placeholder content for the second slide.</p>
      </div> -->
    ...
    <div class="carousel-item  " data-bs-interval="5000">
     <img src="assets/images/papizza/slider-papizza/slider8.jpg" class="d-block w-100 vh-100"  alt="...">
      <!-- <div class="carousel-caption d-none d-md-block">
        <h5>Second slide label</h5>
        <p>Some representative placeholder content for the second slide.</p>
      </div> -->
